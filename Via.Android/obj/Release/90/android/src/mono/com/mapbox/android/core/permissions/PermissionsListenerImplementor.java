...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Mapbox.Android.Core.Permissions.IPermissionsListenerImplementor, Naxam.Mapbox.MapboxAndroidCore", PermissionsListenerImplementor.class, __md_methods);
	}
	...
	public PermissionsListenerImplementor ()
	{
		...
		if (getClass () == PermissionsListenerImplementor.class)
			mono.android.TypeManager.Activate ("Com.Mapbox.Android.Core.Permissions.IPermissionsListenerImplementor, Naxam.Mapbox.MapboxAndroidCore", "", this, new java.lang.Object[] {  });
	}
